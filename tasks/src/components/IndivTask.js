...
function IndivTask({ task }){
    ...
    // DATE FORMATTING
    // const period = "AM"
    // if (Number(task.duetime.toString().slice(11, 13)) > 12){
    //     period = "PM"
    // }

    // const formattedDueDate = {
    //     year: task.deadline.toString().slice(0,4),
    //     month: task.deadline.toString().slice(5,7),
    //     day: task.deadline.toString().slice(8,10),
    //     hour: task.duetime.toString().slice(11, 13),
    //     minutes: task.duetime.toString().slice(14, 16),
    //     period: period
    // }

    // const dueDate = "Due at " + formattedDueDate.month + "/" +
    //                             formattedDueDate.day + "/" +
    //                             formattedDueDate.year + " on " +
    //                             formattedDueDate.hour + ":" +
    //                             formattedDueDate.minutes +
    //                             formattedDueDate.period
